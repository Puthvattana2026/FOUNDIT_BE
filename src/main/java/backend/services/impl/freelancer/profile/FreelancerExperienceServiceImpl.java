...
import backend.repositories.freelancer.profile.FreelancerExperienceRepository;
import backend.repositories.freelancer.profile.FreelancerProfileRepository;
import backend.services.freelancer.profile.FreelancerExperienceService;
...
public class FreelancerExperienceServiceImpl implements FreelancerExperienceService{
	...
	public FreelancerProfile getByFreelancerProfileId(Long id) {
		return freelancerProfileRepository.findById(id).orElseThrow(() -> new RuntimeException("Not Found"));
	}
